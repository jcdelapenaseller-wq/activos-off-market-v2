...
const AuctionSevillaGuide: React.FC = () => {
  const cityAuctions = Object.entries(AUCTIONS).filter(([_, a]) => a.city === "Sevilla");
      ...
      <header className="bg-white pb-12 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 mb-8 shadow-sm">
              <h2 className="text-xl font-serif font-bold text-slate-900 mb-2">
                Subastas con mayor descuento en Sevilla
              </h2>
              <p className="text-slate-600 mb-4">
                Estas son las subastas inmobiliarias detectadas en Sevilla con mayor diferencia entre tasación y deuda.
              </p>
              <Link 
                to="/subastas/sevilla/oportunidades" 
            ...
            <article className="prose prose-lg prose-slate max-w-none prose-headings:font-serif prose-headings:font-bold prose-headings:text-slate-900 prose-p:leading-loose">
              ...
              <div className="bg-white border border-brand-200 p-8 rounded-2xl my-12 shadow-sm">
                  ...
                  <p className="text-slate-600 mb-6">
                      Calcular la puja máxima es clave para no perder dinero. Hemos creado una herramienta específica para analizar subastas en Sevilla.
                  </p>
              ...
              {cityAuctions.length > 0 && (
                <div className="mt-16 pt-12 border-t border-slate-200">
                  <h2 className="text-3xl font-bold mb-8">Ejemplos de subastas inmobiliarias en Sevilla</h2>
