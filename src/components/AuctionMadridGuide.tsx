...
const AuctionMadridGuide: React.FC = () => {
  const cityAuctions = Object.entries(AUCTIONS).filter(([_, a]) => a.city === "Madrid");
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="bg-brand-50 border border-brand-100 rounded-2xl p-6 mb-8">
              <h2 className="text-xl font-serif font-bold text-slate-900 mb-2">
                Las subastas más interesantes detectadas en Madrid
              </h2>
              ...
              >
                Ver las mejores subastas en Madrid
              </Link>
            </div>

            <div className="bg-white border border-slate-200 rounded-2xl p-6 mb-8 shadow-sm">
              <h2 className="text-xl font-serif font-bold text-slate-900 mb-2">
                Subastas con mayor descuento en Madrid
              </h2>
              <p className="text-slate-600 mb-4">
                Estas son las subastas inmobiliarias detectadas en Madrid con mayor diferencia entre tasación y deuda.
              </p>
              <Link 
                to="/subastas/madrid/oportunidades" 
            ...
            <article className="prose prose-lg prose-slate max-w-none prose-headings:font-serif prose-headings:font-bold prose-headings:text-slate-900 prose-p:leading-loose">
              ...
              {cityAuctions.length > 0 && (
                <div className="mt-16 pt-12 border-t border-slate-200">
                  <h2 className="text-3xl font-bold mb-8">Ejemplos de subastas inmobiliarias en Madrid</h2>
