...
const OpportunityAuctions: React.FC = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    if (displayCity) {
      document.title = `Subastas con mayor descuento en ${displayCity} | Oportunidades Inmobiliarias`;
    }
  }, [displayCity]);
        ...
        {opportunities.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl p-12 text-center border border-slate-200 max-w-2xl mx-auto">
            ...
            <p className="text-slate-600 mb-8">
              Actualmente no hemos detectado subastas en {displayCity} con un descuento potencial superior al 40%. 
