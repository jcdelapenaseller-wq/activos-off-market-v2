...
import { Shield, ArrowRight, AlertTriangle, FileText } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="pt-8 border-t border-slate-200 max-w-lg mx-auto">
            <p className="text-slate-700 font-medium mb-6">
              Usado antes de pujar para evitar sorpresas legales
            </p>
          ...
          <div className="mt-12 pt-8 border-t border-slate-100 max-w-md mx-auto">
            <p className="text-slate-500 text-sm mb-3">
              ¿Quieres además la rentabilidad y estrategia de puja?
            </p>
            <Link 
      ...
      {processedId && !isIdealista && (
        <div ref={analysisRef} className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm mb-12">
          <LoadAnalysisBlock 
            boeId={processedId} 
            initialStep="upload" 
            isPaid={isPaidState}
